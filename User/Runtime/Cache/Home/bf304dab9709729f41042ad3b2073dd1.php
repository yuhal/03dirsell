        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                    激活码转账                </h2>
                <form name="form1" method="post" action="/Home/Index/jbzzcl/">
                  <label>
                  激活码转让,数量:
                ...
                <!--  <label>
                  ...
                  <input name="ejmm" type="password" id="ejmm">
                                ...
                                <br>
                  <span >当前可用激活码数量<?php echo ($pin_zs); ?></span>
                </form>
				 <script>
                ...
                <div class="col-md-12">
                    <div class="hpanel">
                        <div class="panel-heading">
                            ...
                            This is a bordered striped and responsive table </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="example_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example_length"><label></label></div>
                                <table id="example" cellpadding="1" cellspacing="1" class="table table-bordered table-striped cus_datatable dataTable no-footer" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                    <thead>
                                    <tr role="row"><th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="编号: activate to sort column ascending" style="width: 103px;">编号</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="用户: activate to sort column ascending" style="width: 103px;">用户</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="PIN码: activate to sort column ascending" style="width: 120px;">激活码</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="状态: activate to sort column ascending" style="width: 103px;">状态</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="生成时间: activate to sort column ascending" style="width: 164px;">生成时间</th><th class="sorting_disabled" rowspan="1" colspan="1" aria-label="使用用户" style="width: 164px;">使用用户</th><th class="sorting_disabled" rowspan="1" colspan="1" aria-label="使用时间" style="width: 164px;">使用时间</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="操作: activate to sort column ascending" style="width: 104px;">操作</th></tr>
                                    </thead>
                                    <tbody>
					  ...
					  <td></td>
                                  ...
                                  <div class="dataTables_paginate paging_simple_numbers" id="example_paginate"><?php echo ($page1); ?></div></div>
                            </div>
                        </div>
