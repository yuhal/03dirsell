...
<!-- Main Wrapper -->
 ...
 <div id="wrapper" style="min-height: 899px;">
      ...
      <div class="panel-body"> <a class="small-header-action" href="">
        ...
        <div id="hbreadcrumb" class="pull-right m-t-lg">
          <ol class="hbreadcrumb breadcrumb">
            <li><a href="">首页</a> </li>
            <li class="active"> <span><a>我的用户群</a></span> </li>
          </ol>
        </div>
        <h2 class="font-light m-b-xs"> 我的用户群 </h2>
        <small>Present your events in timeline style.</small> </div>
    </div>
  </div>
  <div class="content animate-panel">
	<div class="row">
    <div class="col-md-12 animated-panel zoomIn" style="-webkit-animation-delay: 0.2s;">
        <div class="hpanel">
            ...
            <div class="panel-body">
                ...
                <thead>
                  <tr role="row"><th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="编号: activate to sort column ascending" style="width: 106px;">编号</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="金额(MAVRO): activate to sort column ascending" style="width: 181px;">金额(MAVRO)</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="下单时间: activate to sort column ascending" style="width: 214px;">下单时间</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="下单天数: activate to sort column ascending" style="width: 131px;">下单天数</th>
                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" aria-label="用户: activate to sort column ascending" style="width: 239px;">推荐人 </th>
                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="用户: activate to sort column ascending" style="width: 239px;">用户</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="手机号: activate to sort column ascending" style="width: 140px;">手机号</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="状态: activate to sort column ascending" style="width: 82px;">状态</th>
                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" aria-label="状态: activate to sort column ascending" style="width: 82px;">交易状态</th>
                  </tr>
                </thead>
                <tbody>
    ...
    <div class="col-md-12 animated-panel zoomIn" style="-webkit-animation-delay: 0.3s;">
        <div class="hpanel">
            <div class="panel-heading">
                <div class="panel-tools">
                    <a class="showhide"><i class="fa fa-chevron-up"></i></a>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                 <div id="example2_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example2_length"><label></label></div>
                 <table id="example2" cellpadding="1" cellspacing="1" class="table table-bordered table-striped cus_datatable dataTable no-footer" role="grid" aria-describedby="example2_info">
                <thead>
                  <tr role="row"><th class="sorting_desc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="descending" aria-label="编号: activate to sort column ascending" style="width: 114px;">编号</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="金额(MAVRO): activate to sort column ascending" style="width: 244px;">金额(MAVRO)</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="下单时间: activate to sort column ascending" style="width: 179px;">下单时间</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="下单天数: activate to sort column ascending" style="width: 179px;">下单天数</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="用户: activate to sort column ascending" style="width: 114px;">用户</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="手机号: activate to sort column ascending" style="width: 147px;">手机号</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="状态: activate to sort column ascending" style="width: 116px;">状态</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="状态: activate to sort column ascending" style="width: 116px;">交易状态</th></tr>
                </thead>
                <tbody>
                 ...
                 <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><?php echo ($page1); ?></div></div>
                    </div>
...
//alert($action);
//alert($action);
$.post($action,{ymm:$ymm,xmm:$xmm,xmmqr:$xmmqr},function(data){
//alert("asdf");
if(data.sf == 0){
alert(data.nr);
$('#btn').val("重新修改");
