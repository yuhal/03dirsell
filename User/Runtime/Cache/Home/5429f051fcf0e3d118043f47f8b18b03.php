            ...
            <div class="panel-body">
               ...
               <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        <li><a href="">首页</a> </li>
                        <li class="active">
                            <span><a>首页</a></span></li><li class="active">
                            <span><a>新闻公告</a></span>                        </li>
                    </ol>
                </div>
...
<div class="row">
    <div class="col-md-5">
        <div class="hpanel">
				...
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="vertical-timeline-block">
                        <div class="vertical-timeline-icon navy-bg">
                            <i class="fa fa-calendar"></i>
                        </div>
                        <div class="vertical-timeline-content">
                            <div class="p-sm">
                                <span class="vertical-date pull-right"><br> <small><?php echo ($v["if_time"]); ?></small> </span>

                                <h2><?php echo ($v["if_theme"]); ?></h2>
    ...
    <div class="col-md-6">
        <div class="hpanel">
          <div class="v-timeline vertical-container" data-child="vertical-timeline-block" data-delay="1">
			...
			<?php if(is_array($list1)): foreach($list1 as $key=>$b): ?><div class="vertical-timeline-block">
                        <div class="vertical-timeline-icon navy-bg">
                            <i class="fa fa-calendar"></i>
                        </div>
                        <div class="vertical-timeline-content">
                            <div class="p-sm">
                                <span class="vertical-date pull-right"> <br> <small><?php echo ($b["if_time"]); ?></small> </span>

                                <h2><?php echo ($b["if_theme"]); ?></h2>
                                <p><?php echo ($b["if_content"]); ?></p>
                            </div>
                            <div class="panel-footer">
                               帮助中心                            </div>
                        </div>
