...
<div class="row">
    <div class="col-lg-12">
        <div class="col-md-12">
            <div class="hpanel">
                <div class="panel-body">
                        <form action="<?php echo U('Home/Info/xgyjmmcl');?>" name="xgmm" id="xgmm" method="post">
                            <div class="row">
                            ...
                            <div class="text-center">
								...
								<input name="" type="button" class="btn btn-success" value="确认修改" id="btn">
	...
	<div class="col-lg-12">
        <div class="col-md-12">
            <div class="hpanel">
                <div class="panel-body">
                        <form action="<?php echo U('Home/Info/xgejmmcl');?>" name="xgmmej" id="xgmmej" method="post">
                            <div class="row">
                            ...
                            <div class="text-center">
								...
								<input name="" type="submit" class="btn btn-success" value="确认修改" >
