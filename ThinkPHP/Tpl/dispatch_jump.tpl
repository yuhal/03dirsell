...
<body class="login">
	...
	<div class="content">
		...
		<div class="loading">     <div class="splash"> <div class="color-line"></div><div class="splash-title"><h1>六星资本</h1><p>世界上最简便的财富管理互助平台 </p><h3>
...
var interval = setInterval(function(){
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2015-2016@copyrights. www.czfz123.com Alright Reserved.
	</div>
